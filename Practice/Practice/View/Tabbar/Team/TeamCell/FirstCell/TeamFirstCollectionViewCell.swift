//
//  TeamFirstCollectionViewCell.swift
//  Practice
//
...
class TeamFirstCollectionViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        collectionView.registerCell(TeamRecruitCollectionViewCell.self)
...
extension TeamFirstCollectionViewCell: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell: TeamRecruitCollectionViewCell = collectionView.dequeueCollectionCell(for: indexPath)
